...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { abbreviation: @field.abbreviation, description: @field.description, status: @field.status }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { abbreviation: @field.abbreviation, description: @field.description, status: @field.status }
    assert_redirected_to field_path(assigns(:field))
  end
