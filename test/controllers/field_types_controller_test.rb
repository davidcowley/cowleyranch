...
class FieldTypesControllerTest < ActionController::TestCase
  ...
  test "should create field_type" do
    assert_difference('FieldType.count') do
      post :create, field_type: { abbreviation: @field_type.abbreviation, description: @field_type.description, status: @field_type.status }
    end
  ...
  test "should update field_type" do
    patch :update, id: @field_type, field_type: { abbreviation: @field_type.abbreviation, description: @field_type.description, status: @field_type.status }
    assert_redirected_to field_type_path(assigns(:field_type))
  end
